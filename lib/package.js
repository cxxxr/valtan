...
import { typeError, isString } from './header';
import { makeSymbol, isSymbol, symbolName } from './symbol';
...
export const cl_package = makePackage('COMMON-LISP', { nicknames: ['CL'] });
...
export const cl_user_package = makePackage('COMMON-LISP-USER', { nicknames: ['CL-USER'] });
