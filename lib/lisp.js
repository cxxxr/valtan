...
import { cl_package, system_package, intern, findPackage, ensurePackage,
  CL_packageName, CL_findPackage
} from './package';
export * from './package';
...
//////////////////////////////////////////////////
// package
registerFunction(cl_package, 'PACKAGE-NAME', CL_packageName);
registerFunction(cl_package, 'FIND-PACKAGE', CL_findPackage);
