...
export function callFunction(symbol, ...args) {
  ...
  if (func.min !== undefined) {
    if (args.length < func.min || (func.max !== null && func.max < args.length)) {
...
registerFunction(cl_package, 'CONSP', consp, 1);
registerFunction(cl_package, 'CONS', cons, 2);
registerFunction(cl_package, 'CAR', car, 1);
registerFunction(cl_package, 'CDR', cdr, 1);
registerFunction(cl_package, 'RPLACA', rplaca, 2);
registerFunction(cl_package, 'RPLACD', rplacd, 2);
