    ...
    (delete-if (lambda (bb)
                 (let* ((code (basic-block-code bb))
                   ...
                   (when (and (eq (lir-op lir) 'label)
                     ...
                     (cond ((= 1 (length code))
                            (dolist (bb2 (basic-block-pred bb))
                              (setf (basic-block-succ bb2)
                                    (delete bb (basic-block-succ bb2))))
                            (dolist (bb2 (basic-block-succ bb))
                              (setf (basic-block-pred bb2)
                                    (delete bb (basic-block-pred bb2))))
                            t)
                           (t
