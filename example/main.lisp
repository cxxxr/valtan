...
(test (EQUALP (MAP (QUOTE (SIMPLE-ARRAY * 1)) (FUNCTION +) #(0 1) #(1 0)) #(1 1)))
(test (EQUALP (MAP (QUOTE (ARRAY * (2))) (FUNCTION +) #(0 1) #(1 0)) #(1 1)))
(test (EQUALP (MAP (QUOTE (SIMPLE-ARRAY * (2))) (FUNCTION +) #(0 1) #(1 0)) #(1 1)))
(test (STRING= (MAP (QUOTE STRING) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE BASE-STRING) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE SIMPLE-STRING) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE (STRING 3)) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE (BASE-STRING 3)) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE (SIMPLE-STRING 3)) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE (VECTOR CHARACTER)) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE (VECTOR CHARACTER 3)) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE (VECTOR BASE-CHAR)) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE (VECTOR BASE-CHAR 3)) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE (VECTOR STANDARD-CHAR)) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE (VECTOR STANDARD-CHAR 3)) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE (ARRAY CHARACTER 1)) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE (ARRAY CHARACTER (3))) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE (ARRAY BASE-CHAR 1)) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE (ARRAY BASE-CHAR (3))) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE (ARRAY STANDARD-CHAR 1)) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (STRING= (MAP (QUOTE (ARRAY STANDARD-CHAR (3))) (FUNCTION CHAR-UPCASE) "abc") "ABC"))
(test (EQUALP (MAP (QUOTE BIT-VECTOR) (FUNCTION LOGAND) (QUOTE (0 1 0 1)) #(1 0 1 0)) #(0 0 0 0)))
(test (EQUALP (MAP (QUOTE SIMPLE-BIT-VECTOR) (FUNCTION LOGAND) (QUOTE (0 1 0 1)) #(1 0 1 0)) #(0 0 0 0)))
(test (EQUALP (MAP (QUOTE (BIT-VECTOR 4)) (FUNCTION LOGAND) (QUOTE (0 1 0 1)) #(1 0 1 0)) #(0 0 0 0)))
(test (EQUALP (MAP (QUOTE (SIMPLE-BIT-VECTOR 4)) (FUNCTION LOGAND) (QUOTE (0 1 0 1)) #(1 0 1 0)) #(0 0 0 0)))
(test (EQUALP (MAP (QUOTE (ARRAY BIT 1)) (FUNCTION LOGAND) (QUOTE (0 1 0 1)) #(1 0 1 0)) #(0 0 0 0)))
(test (EQUALP (MAP (QUOTE (ARRAY BIT (4))) (FUNCTION LOGAND) (QUOTE (0 1 0 1)) #(1 0 1 0)) #(0 0 0 0)))
(test (EQUALP (MAP (QUOTE (SIMPLE-ARRAY BIT 1)) (FUNCTION LOGAND) (QUOTE (0 1 0 1)) #(1 0 1 0)) #(0 0 0 0)))
(test (EQUALP (MAP (QUOTE (SIMPLE-ARRAY BIT (4))) (FUNCTION LOGAND) (QUOTE (0 1 0 1)) #(1 0 1 0)) #(0 0 0 0)))
(test (EQUALP (MAP (QUOTE (VECTOR BIT)) (FUNCTION LOGAND) (QUOTE (0 1 0 1)) #(1 0 1 0)) #(0 0 0 0)))
(test (EQUALP (MAP (QUOTE (VECTOR BIT 4)) (FUNCTION LOGAND) (QUOTE (0 1 0 1)) #(1 0 1 0)) #(0 0 0 0)))
(test (EQUAL (MAP (QUOTE LIST) (FUNCTION +) (QUOTE (0 1 2 3)) #(3 2 1 0) #(0 1 0 1)) (QUOTE (3 4 3 4))))
(test (EQUALP (MAP (QUOTE VECTOR) (FUNCTION +) (QUOTE (0 1 2 3)) #(3 2 1 0) #(0 1 0 1)) #(3 4 3 4)))
