...
;; (print (EQUALP (MAP (QUOTE (SIMPLE-VECTOR 2)) (FUNCTION +) #(0 1) #(1 0)) #(1 1)))
;; (print (NULL (FIND (QUOTE A) (QUOTE (A B C)) :END 0)))
;; (print (NULL (FIND (QUOTE B) (QUOTE (A B C)) :END 1)))
;; (print (NULL (FIND (QUOTE C) (QUOTE (A B C)) :END 2)))
;; (print (EQUAL (FIND (QUOTE A) (QUOTE ((A) (B) (C))) :KEY (FUNCTION CAR)) (QUOTE (A))))
;; (print (EQUAL (FIND (QUOTE B) (QUOTE ((A) (B) (C))) :KEY (FUNCTION CAR)) (QUOTE (B))))
;; (print (EQUAL (FIND (QUOTE C) (QUOTE ((A) (B) (C))) :KEY (FUNCTION CAR)) (QUOTE (C))))
;; (print (LET ((LIST (QUOTE ((A) (B) (C))))) (AND (EQ (FIND (QUOTE A) LIST :KEY (FUNCTION CAR)) (CAR LIST)) (EQ (FIND (QUOTE B) LIST :KEY (FUNCTION CAR)) (CADR LIST)) (EQ (FIND (QUOTE C) LIST :KEY (FUNCTION CAR)) (CADDR LIST)) (NULL (FIND (QUOTE Z) LIST :KEY (FUNCTION CAR))))))
;; (print (EQUAL (FIND (QUOTE A) (QUOTE ((A) (B) (C) (A A) (B B) (C C))) :KEY (FUNCTION CAR)) (QUOTE (A))))
;; (print (EQUAL (FIND (QUOTE A) (QUOTE ((A) (B) (C) (A A) (B B) (C C))) :KEY (FUNCTION CAR) :FROM-END T) (QUOTE (A A))))
;; (print (EQUAL (FIND (QUOTE B) (QUOTE ((A) (B) (C) (A A) (B B) (C C))) :KEY (FUNCTION CAR)) (QUOTE (B))))
;; (print (EQUAL (FIND (QUOTE B) (QUOTE ((A) (B) (C) (A A) (B B) (C C))) :KEY (FUNCTION CAR) :FROM-END T) (QUOTE (B B))))
;; (print (EQUAL (FIND (QUOTE C) (QUOTE ((A) (B) (C) (A A) (B B) (C C))) :KEY (FUNCTION CAR)) (QUOTE (C))))
;; (print (EQUAL (FIND (QUOTE C) (QUOTE ((A) (B) (C) (A A) (B B) (C C))) :KEY (FUNCTION CAR) :FROM-END T) (QUOTE (C C))))
;; (print (EQUAL (FIND (QUOTE A) (QUOTE ((A) (B) (C) (A A) (B B) (C C) (A A A))) :KEY (FUNCTION CAR) :FROM-END T) (QUOTE (A A A))))
;; (print (EQUAL (FIND (QUOTE A) (QUOTE ((A) (B) (C) (A A) (B B) (C C) (A A A))) :KEY (FUNCTION CAR) :FROM-END T :END NIL) (QUOTE (A A A))))
;; (print (EQUAL (FIND (QUOTE A) (QUOTE ((A) (B) (C) (A A) (B B) (C C) (A A A))) :KEY (FUNCTION CAR) :FROM-END T :END 6) (QUOTE (A A))))
;; (print (STRING= (FIND "c" (QUOTE ("abc" "bcd" "cde")) :KEY (FUNCTION (LAMBDA (ARG) (CHAR ARG 0))) :TEST (FUNCTION CHAR=)) "cde"))
;; (print (STRING= (FIND "c" (QUOTE ("abc" "bcd" "cde")) :KEY (FUNCTION (LAMBDA (ARG) (CHAR ARG 0))) :TEST (FUNCTION CHAR>)) "abc"))
;; (print (STRING= (FIND "c" (QUOTE ("abc" "bcd" "cde")) :START 1 :KEY (FUNCTION (LAMBDA (ARG) (CHAR ARG 0))) :TEST (FUNCTION CHAR>)) "bcd"))
