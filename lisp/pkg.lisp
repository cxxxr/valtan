(defpackage :common-lisp
  ...
  (:export #:&allow-other-keys #:&aux #:&body #:&environment #:&key
           ...
           #:apply #:apropos #:apropos-list #:aref #:arithmetic-error
           ...
           #:base-char #:base-string #:bignum #:bit #:bit-and #:bit-andc1
           #:bit-andc2 #:bit-eqv #:bit-ior #:bit-nand #:bit-nor #:bit-not
           #:bit-orc1 #:bit-orc2 #:bit-vector #:bit-vector-p #:bit-xor
           #:block #:boole #:boole-1 #:boole-2 #:boole-and #:boole-andc1
           #:boole-andc2 #:boole-c1 #:boole-c2 #:boole-clr #:boole-eqv
           #:boole-ior #:boole-nand #:boole-nor #:boole-orc1 #:boole-orc2
           #:boole-set #:boole-xor #:boolean #:both-case-p #:boundp #:break
           ...
           #:caddar #:cadddr #:caddr #:cadr #:call-arguments-limit
           #:call-method #:call-next-method #:car #:case #:catch #:ccase
           ...
           #:class-of #:clear-input #:clear-output #:close #:clrhash
           #:code-char #:coerce #:compilation-speed #:compile #:compile-file
           ...
           #:cond #:condition #:conjugate #:cons #:consp #:constantly
           ...
           #:do-external-symbols #:do-symbols #:documentation #:dolist
           ...
           #:equal #:equalp #:error #:etypecase #:eval #:eval-when #:evenp
           ...
           #:initialize-instance #:inline #:input-stream-p #:inspect
           ...
           #:nconc #:next-method-p #:nil #:nintersection #:ninth
           ...
           #:synonym-stream #:synonym-stream-symbol #:t #:tagbody #:tailp
           ...
           #:unexport #:unintern #:union #:unless #:unread-char
           ...
           #:values #:values-list #:variable #:vector #:vector-pop
           #:vector-push #:vector-push-extend #:vectorp #:warn #:warning
